...
Traffic.add(
    ...
    "APT", "High", "HTTP", '2018-05-20 18:50:26', "APT-Report", "apt.pcap"
)

Traffic.add(
    80, 55342, "192.168.33.128", "104.171.117.216",
    "Hang HTTP Request", "Low", "HTTP", '2018-05-20 18:50:26', "Abnormal", "apt.pcap"
)

Malware.add(
    "79A508BA42247DDF92ACCBF5987B1FFC7BA20CD11806D332979D8A8FE85ABB04",
    "4F92D364CE871C1AEBBF3C5D2445C296EF535632.exe", '2018-05-20 18:50:26', "APT 28 Dropper",
